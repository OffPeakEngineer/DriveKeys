...
void report() {
  if (joyAU != joystickA.up) {
    ...
    strcpy(currentVideoName, "A UP (towards connector)");
  }
    ...
    strcpy(currentVideoName, "A DOWN (away connector)");
  }
    ...
    strcpy(currentVideoName, "A LEFT (<--)");
  }
    ...
    strcpy(currentVideoName, "A RIGHT (-->)");
  }
    ...
    strcpy(currentVideoName, "A PRESSED (center)");
  }
  ...
  if (joyBU != joystickB.up) {
    ...
    strcpy(currentVideoName, "B UP (towards connector)");
  }
    ...
    strcpy(currentVideoName, "B DOWN (away connector)");
  }
    ...
    strcpy(currentVideoName, "B LEFT (<--)");
  }
    ...
    strcpy(currentVideoName, "B RIGHT (-->)");
  }
    ...
    strcpy(currentVideoName, "B PRESSED (center)");
  }
